interface ZIF_BAPI_EPM_PRODUCT_GET_LIST
  public .
  ...
  types:
    __BAPI_EPM_PRODUCT_HEADER      type standard table of BAPI_EPM_PRODUCT_HEADER        with non-unique default key .
  types:
  ...
  types:
    begin of BAPI_EPM_PRODUCT_CATEG_RANGE,
      SIGN type BAPISIGN,
      OPTION type BAPIOPTION,
      LOW type SNWD_PRODUCT_CATEGORY,
      HIGH type SNWD_PRODUCT_CATEGORY,
    end of BAPI_EPM_PRODUCT_CATEG_RANGE .
  types:
    __BAPI_EPM_PRODUCT_CATEG_RANGE type standard table of BAPI_EPM_PRODUCT_CATEG_RANGE   with non-unique default key .
  types:
  ...
  types:
    begin of BAPI_EPM_SUPPLIER_NAME_RANGE,
      SIGN type BAPISIGN,
      OPTION type BAPIOPTION,
      LOW type SNWD_COMPANY_NAME,
      HIGH type SNWD_COMPANY_NAME,
    end of BAPI_EPM_SUPPLIER_NAME_RANGE .
  types:
    __BAPI_EPM_SUPPLIER_NAME_RANGE type standard table of BAPI_EPM_SUPPLIER_NAME_RANGE   with non-unique default key .
endinterface.
