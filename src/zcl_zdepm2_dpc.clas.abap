class ZCL_ZDEPM2_DPC definition
  public
...
protected section.
  ...
  methods PRODUCTSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZDEPM2_MPC=>TS_PRODUCT
    raising
  ...
  methods PRODUCTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZDEPM2_MPC=>TT_PRODUCT
...
CLASS ZCL_ZDEPM2_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 15.02.2025 14:22:59 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZDEPM2_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA productset_create_entity TYPE zcl_zdepm2_mpc=>ts_product.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_get_entity TYPE zcl_zdepm2_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZDEPM2_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA productset_get_entityset TYPE zcl_zdepm2_mpc=>tt_product.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_update_entity TYPE zcl_zdepm2_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
